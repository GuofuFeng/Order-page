...
export const REGEX_MULTI_ZODIAC_V2 = /(?:^|[\s,，。；;.])([马蛇龙兔虎牛鼠猪狗鸡猴羊]{2,12})(复试|复式|复)?([二三四五六七八九十2345678910两])(?:连肖|连|连各)?(?:各组)?(?:各|买|压|个)?(\d+(?:\.\d+)?|[零一二三四五六七八九十百千万壹贰叁肆伍陆柒捌玖拾两廿卅佰仟]+)(?:米|个|元|块)?/g;
export const REGEX_TUO_ZODIAC_V3 = /(?:^|[\s,，。；;.])([马蛇龙兔虎牛鼠猪狗鸡猴羊]{1,11})拖([马蛇龙兔虎牛鼠猪狗鸡猴羊]{1,11})([二三四五六七八九十2345678910两])(?:连肖|连|连各)?(?:各|买|压|个)?(\d+(?:\.\d+)?|[零一二三四五六七八九十百千万壹贰叁肆伍陆柒捌玖拾两廿卅佰仟]+)(?:米|个|元|块)?/g;
